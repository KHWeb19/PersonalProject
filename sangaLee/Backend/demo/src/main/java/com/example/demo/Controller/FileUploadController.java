...
import com.example.demo.Controller.request.RequestFileInfo;
    ...
    public String requestUploadFile (
        ...
        try {
            for (MultipartFile multipartFile : fileList) {
                 ...
                 */
                FileOutputStream writer = new FileOutputStream(
                        "c:/khweb19/personalproject/sangalee/frontend/src/assets/uploadImg/" + multipartFile.getOriginalFilename());
