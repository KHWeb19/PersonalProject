                  ...
                  <v-row wrap>
                        <v-btn class="writeBtn" color="black" dark>
                            <router-link :to="{ name: 'MarketReadPage',
                                    params: { boardNo: market.boardNo.toString() } }" style="color:white">cancle</router-link></v-btn>
...
export default {
    ...
    created () {
        ...
        this.content = this.market.content
        this.price = this.market.price
        this.category = this.market.category
    },
    methods: {
        handleFileUpload () {
        ...
        onSubmit () {
            ...
            const { title, writer, content, category, price, usedCondition, viewCnt} = this
