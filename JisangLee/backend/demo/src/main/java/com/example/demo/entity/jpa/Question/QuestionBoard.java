...
public class QuestionBoard {
    ...
    @Formula("(SELECT count(1) FROM question_comment c WHERE c.question_board_board_no = board_no)")
    ...
    @OneToMany(mappedBy = "questionBoard", fetch = FetchType.EAGER, cascade = CascadeType.REMOVE)
