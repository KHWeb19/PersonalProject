...
public class LocalBoard {
    ...
    @Formula("(SELECT count(1) FROM local_comment c WHERE c.local_board_board_no = board_no)")
    ...
    @OneToMany(mappedBy = "localBoard", fetch = FetchType.EAGER, cascade = CascadeType.REMOVE)
