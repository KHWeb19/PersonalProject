<template>
    ...
    <!-- <td style="padding-left: 8px; position: absolute; top: 680px;" colspan="3" v-if="onLike"> -->
        <td style="padding-left: 8px;" colspan="3" v-if="onLike">
    ...
    <td style="padding-left: 8px;" colspan="3" v-else >
        <v-btn icon @click="onLikes" >
            <v-icon  color="black">
