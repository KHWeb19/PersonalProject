<template>
   <div class="app">
        <h3 style="padding:30px 0px 30px 0px; font-weight:bold" align="left">질문 게시판 ReadPage</h3>
                ...
                outlined type="text" :value="QuestionBoard.title" readonly />
              ...
              <v-text-field
                ...
                <v-textarea
                    ...
                    id="textarea-rows"
                    placeholder=""
                    rows="8" :value="QuestionBoard.content" readonly>
                </v-textarea>
